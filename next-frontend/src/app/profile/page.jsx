...
export default function Profile() {
    const { user, isAuthenticated, logout, updateProfile, setUser } = useAuth();
    ...
    if (!isAuthenticated) {
        return (
            <div className="profile-gate" id="profileGate" style={{ padding: 'var(--space-4xl) 0', textAlign: 'center' }}>
                <h2>Please log in to view your profile</h2>
                <p style={{ marginTop: 'var(--space-md)' }}>Sign in to access your orders, addresses, and account settings.</p>
            </div>
        );
    }
